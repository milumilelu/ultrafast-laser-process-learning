...
class DemoService:
    ...
    def _ensure_equipment() -> dict[str, Any]:
        ...
        create_equipment_profile(EquipmentProfileCreate(
            ...
            field_verification={
                "wavelength_nm": "MEASURED",
                "pulse_width_min_fs": "MEASURED",
                "pulse_width_max_fs": "MEASURED",
                "average_power_min_W": "MEASURED",
                "average_power_max_W": "MEASURED",
                "actual_power_W": "MEASURED",
                "frequency_min_kHz": "MEASURED",
                "frequency_max_kHz": "MEASURED",
                "spot_diameter_um": "MEASURED",
                "scan_speed_min_mm_s": "MEASURED",
                "scan_speed_max_mm_s": "MEASURED",
            },
